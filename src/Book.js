...
function Book() {
  return (
    <div style={{paddingTop:'10rem'}}>
        <div class="mx-14 mt-10 border-2 border-[#008D7D] rounded-lg">
  <div class="mt-10 text-center font-bold"></div>
  <div class="serv mt-3 text-center text-4xl font-bold">Make an Appointment</div>
  <div class="p-8">
    ...
    <div class="text-center">
      <a class="hub cursor-pointer rounded-lg bg-[#008D7D] px-8 py-4 text-sm font-semibold text-white">Book Appoinment</a>
    </div>
  </div>
</div>
    </div>
