...
function Home() {
  return (
    <div>
      ...
      <div class=" padd relative bg-yellow-50">
        <div class="container m-auto px-6 pt-32 md:px-12 lg:pt-[4.8rem] lg:px-7">
            <div class="flex items-center flex-wrap px-2 md:px-0">
                <div className=" move relative lg:w-6/12 lg:py-24 xl:py-32">
                    ...
                    <form action="" class="w-full mt-12">
                        <div class=" search relative flex p-1 rounded-full bg-white border border-yellow-200 shadow-md md:p-2">
                            ...
                            <button    type="button" title="Start buying" class="bg-[#008D7D] ml-auto py-3 px-6 rounded-full text-center transition bg-gradient-to-b  hover:to-red-300 active:from-yellow-400 focus:from-red-400 md:px-12">
                                <span style={{color:'white'}} class="hub hidden text-yellow-900 font-semibold md:block">
Search
                                </span>
                                <svg style={{color:'white'}}  xmlns="http://www.w3.org/2000/svg" class="w-5 mx-auto text-yellow-900 md:hidden" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
<path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
                                </svg>
                            </button>
                        </div>
                    </form>
                    <p class="description mt-8 text-gray-700 lg:w-10/12">Our website ensures healthcare accessibility by connecting users to nearby hospitals and clinics, while also empowering healthcare providers by generating client opportunities through seamless booking and appointment management.</p>
  ...
  <li class="icon-content">
    ...
    <div class="tooltip">Telegram</div>
                ...
                <div class="ml-auto -mb-24 lg:-mb-0 lg:w-6/12">
                    <img style={{paddingBottom:"4rem"}} src={image} class="img-fluid " alt="food illustration" loading="lazy" width="4500" height="4500"/>
                </div>
            </div>
        </div>
    </div>
